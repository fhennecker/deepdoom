...
in that case a fully-observable environment.
...
\begin{figure}
	...
	\subfloat[DQN]{\includegraphics[width=.5\textwidth]{Graphs/success_DRQN.pdf}}
...
\begin{figure}
	...
	\subfloat[DQN]{\includegraphics[width=.5\textwidth]{Graphs/qval_DRQN.pdf}}
