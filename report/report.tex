...
We run our simulations on a gaming class computer, in order to use
GPU-accelerated neural network processing capabilities from tensorflow.
The machine configuration is detailled below.
...
fully observable. In this setup, the metric fed to our game features sub-network
is the relative horizontal position of the ennemy in the field of view of our player
...
we use another game feature: a binary label indicating wether the ennemy is visible
or not.
