...
the art of the technologies that we used in our implementation so that the
inexperimented user can easily follow.
...
\begin{algorithmic}[1]
	\For{number of episodes}
		...
		\EndWhile
		\For{number of backpropagation steps}
...
enemy in front of and visible by the agant. The scenario ends when the agent
